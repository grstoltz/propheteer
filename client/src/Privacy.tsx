...
const Privacy = () => {
	return (
		<>
			...
			/>
			<Layout>
				<Text fontSize="4xl">Privacy Policy</Text>
				<Text fontSize="md">
					<Text mt={4} fontWeight="bold">
						Owner and Data Controller
					</Text>
					<Text mt={4}>Grant Stoltz</Text>
					<Text mt={4}>Owner contact email: help@grantstoltz.com</Text>
					<Text mt={4} fontWeight="bold">
					...
					<Text mt={4}>
						...
						this Application. Unless specified otherwise, all Data
						requested by this Application is mandatory and failure to
						provide this Data may make it impossible for this Application
						...
						uncertain about which Personal Data is mandatory are welcome
						to contact the Owner. Any use of Cookies &ndash; or of other
						tracking tools &ndash; by this Application or by the owners of
						third-party services used by this Application serves the
						purpose of providing the Service required by the User, in
						addition to any other purposes described in the present
					...
					<Text>
						...
						at any time. Legal basis of processing
					</Text>
					<Text mt={4}>
					...
					<Text mt={4}>
						...
						such processing (&ldquo;opt-out&rdquo;), without having to
						rely on consent or any other of the following legal bases.
						This, however, does not apply, whenever the processing of
					...
					<Text>
						...
						Owner&rsquo;s legitimate interests shall be retained as long
						as needed to fulfill such purposes. Users may find specific
						information regarding the legitimate interests pursued by the
						Owner within the relevant sections of this document or by
					...
					<Text mt={4}>
						...
						Analytics, Tag Management and Registration and authentication.
					</Text>
					<Text mt={4}>
						For specific information about the Personal Data used for each
						purpose, the User may refer to the section &ldquo;Detailed
						information on the processing of Personal Data&rdquo;.
					</Text>
					<Text mt={4} fontSize="lg" fontWeight="bolder">
					...
					<Text mt={4}>
						...
						<Text mt={2}>Privacy Shield participant. </Text>
					</Text>
					<Text mt={4}>
						<Text fontWeight="bold">Registration and authentication</Text>
						<Text mt={2}>
							By registering or authenticating, Users allow this
							Application to identify them and give them access to
							dedicated services. Depending on what is described below,
							third parties may provide registration and authentication
							services. In this case, this Application will be able to
							access some Data, stored by these third-party services, for
							registration or identification purposes. Some of the
							services listed below may also collect Personal Data for
							targeting and profiling purposes; to find out more, please
							refer to the description of each service.
						</Text>
						...
						<Text mt={2}>
							...
							provided by Google LLC and is connected to the Google
							network.
						</Text>
						<Text mt={2}>
					...
					<Text mt={4}>
						...
						<Text mt={2}>
							...
							fashion. This results in the Users' Data flowing through
							these services, potentially resulting in the retention of
							this Data.
						</Text>
						<Text mt={2} fontWeight="medium">
						...
						<Text mt={2}>Personal Data processed: Usage Data.</Text>
						<Text mt={2}>
							Place of processing: United States -{" "}
							<Link href="https://policies.google.com/privacy">
								Privacy Policy
					...
					<Text mt={4}>
						...
						<Text>
							...
							to object to the processing of their Data if the processing
							is carried out on a legal basis other than consent. Further
							details are provided in the dedicated section below.
						</Text>
						<Text>
							- Access their Data. Users have the right to learn if Data
							is being processed by the Owner, obtain disclosure
						...
						<Text>
							...
							verify the accuracy of their Data and ask for it to be
					...
					<Text mt={4}>
						...
						the basis of the User&rsquo;s consent, the Owner shall collect
