		...
		<Layout>
			...
			<Text fontSize="md">
				...
				<Text mt={4}>
					...
					collection. Personal Data may be freely provided by the User, or,
					in case of Usage Data, collected automatically when using this
					Application. Unless specified otherwise, all Data requested by
					this Application is mandatory and failure to provide this Data
					...
					the functioning of the Service. Users who are uncertain about
					which Personal Data is mandatory are welcome to contact the
					Owner. Any use of Cookies &ndash; or of other tracking tools
					&ndash; by this Application or by the owners of third-party
					services used by this Application serves the purpose of providing
					the Service required by the User, in addition to any other
					purposes described in the present document and in the Cookie
					Policy, if available.
				</Text>
				<Text mt={4}>
				...
				<Text>
					...
					may be requested from the Owner at any time. Legal basis of
					processing
				</Text>
				<Text mt={4}>
				...
				<Text mt={4}>
					...
					processing (&ldquo;opt-out&rdquo;), without having to rely on
					consent or any other of the following legal bases. This, however,
					does not apply, whenever the processing of Personal Data is
				...
				<Text mt={4}>
					...
					or set up by two or more countries, such as the UN, and about the
				...
				<Text mt={4}>
					...
					fraudulent activity, as well as the following: Analytics, Tag
					Management and Registration and authentication.
				</Text>
				<Text mt={4}>
				...
				<Text mt={4}>
					...
					<Text mt={2}>
						...
						LLC (“Google”). Google utilizes the Data collected to track
					...
					<Text mt={2}>Personal Data processed: Cookies; Usage Data.</Text>
					<Text mt={2}>
				...
				<Text mt={4}>
					...
					<Text mt={2}>
						...
						identification purposes. Some of the services listed below may
						also collect Personal Data for targeting and profiling
						purposes; to find out more, please refer to the description of
						each service.
					</Text>
				...
				<Text mt={4}>
					...
					<Text mt={2}>
						...
						scripts needed on this Application in a centralized fashion.
						This results in the Users' Data flowing through these
						services, potentially resulting in the retention of this Data.
					</Text>
					<Text mt={2} fontWeight="medium">
				...
				<Text mt={4}>
					...
					contact information at the beginning of this document. How
					&ldquo;Do Not Track&rdquo; requests are handled
				</Text>
				<Text mt={4}>
					...
					uses honor the &ldquo;Do Not Track&rdquo; requests, please read
